    ...
    return (
        <>
            <div className='min-h-screen bg-gradient-to-r from-orange-200 via-orange-400 to-orange-600 flex flex-col items-center justify-center text-gray-800'>
                <div className='text-7xl justify-center text-center text-white pb-6'>Welcome, {user.username}</div>
                <div className='text-7xl justify-center text-center text-white pb-6'>How can I help you today?</div>
